...
class CartController extends Controller
{
    ...
    public function place_an_order(Request $request){
        ...
        $order->subtotal = (int)str_replace(',', '', Session::get('checkout')['subtotal']); // Loại bỏ dấu phẩy
        $order->discount = (int)str_replace(',', '', Session::get('checkout')['discount']);
        $order->tax = (int)str_replace(',', '', Session::get('checkout')['tax']);
        $order->total = (int)str_replace(',', '', Session::get('checkout')['total']);
        ...
        foreach(Cart::instance('cart')->content() as $item){
            ...
            $orderItem->price = (int)str_replace(',', '', $item->price); // Xử lý giá của sản phẩm
