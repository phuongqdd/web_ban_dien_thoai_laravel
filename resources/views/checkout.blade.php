              ...
              <div class="checkout__totals">
                ...
                <table class="checkout-totals">
                    <tbody>
                        <tr>
                          <th>Subtotal</th>
                          <td class="text-right">{{Cart::instance('cart')->subTotal()}}VNĐ</td>
                        </tr>
                        <tr>
                          <th>Discount: {{Session::get('coupon')['code']}}</th>
                          <td class="text-right">{{Session::get('discounts')['discount']}}VNĐ</td>
                        </tr>
                        <tr>
                          <th>Subtotal After Discount</th>
                          <td class="text-right">{{Session::get('discounts')['subtotal']}}VNĐ</td>
                        </tr>
                        <tr>
                          <th>Shipping</th>
                          <td class="text-right">
                        ...
                        <tr>
                          <th>VAT</th>
                          <td class="text-right">{{Session::get('discounts')['tax']}}VNĐ</td>
                        </tr>
                        <tr>
                          <th>Total</th>
                          <td class="text-right">{{Session::get('discounts')['total']}}VNĐ</td>
                        </tr>
                      </tbody>
                  </table>
                @else
