        ...
        <div class="accordion" id="price-filters">
          <div class="accordion-item mb-4">
            ...
            <div id="accordion-filter-price" class="accordion-collapse collapse show border-0"
              ...
              <input class="price-range-slider" type="text" name="con_dien" value="" data-slider-min="0"
                data-slider-max="1000000000" data-slider-step="5" data-slider-value="[{{$min_price}}, {{$max_price}}]" data-currency="VNĐ" />
              <div class="price-range__info d-flex align-items-center mt-2">
                <div class="me-auto">
                  <span class="text-secondary">Min Price: </span>
                  <span class="price-range__min">VNĐ0</span>
                </div>
                <div>
                  <span class="text-secondary">Max Price: </span>
                  <span class="price-range__max">VNĐ1000000000</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page Size" id ="pagesize"
              name="pagezise" style="margin-right: 20px">
            ...
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Sort Items"
              ...
              <option value="2" {{$order == 2 ? "selected" : ""}}>Date, New To New</option>
              <option value="3" {{$order == 3 ? "selected" : ""}}>Price, Low To High</option>
              <option value="4" {{$order == 4 ? "selected" : ""}}>Price, Low To Low</option>
            </select>
                    ...
                    <div class="pc__img-wrapper">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                ...
                                <a href="{{route('shop.product.details', ['product_slug' => $product->slug])}}"><img loading="lazy" src="{{asset('uploads/products')}}/{{$gimg}}" width="330"
                                    height="400" alt="{{$product->name}}" class="pc__img"></a>
                                @endforeach
                            </div>
                        </div>
...
@push('scripts')
    <script>
      $(function(){
        ...
        $("input[name='con_dien']").on("change", function() {
