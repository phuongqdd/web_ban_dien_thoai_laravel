              ...
              <tr>
                <td>
                  <div class="shopping-cart__product-item">
                    <img loading="lazy" src="{{asset('uploads/products/thumsnails')}}/{{$item->model->image}}" width="120" height="120" alt="{{$item->name}}" />
                  </div>
                </td>
                <td>
                ...
                <td>
                  <div class="qty-control position-relative">
                    ...
                    <form method="POST" action="{{route('cart.qty.descrease', ['rowId' =>$item->rowId])}}">
                      @csrf
                      @method('PUT')
            ...
            <div class="shopping-cart__totals">
              ...
              <table class="cart-totals">
                <tbody>
                  <tr>
                    <th>Subtotal</th>
                    <td>{{Cart::instance('cart')->subTotal()}}VNĐ</td>
                  </tr>
                  <tr>
                    <th>Discount: {{Session::get('coupon')['code']}}</th>
                    <td>{{Session::get('discounts')['discount']}}VNĐ</td>
                  </tr>
                  <tr>
                    <th>Subtotal After Discount</th>
                    <td>{{Session::get('discounts')['subtotal']}}VNĐ</td>
                  </tr>
                  <tr>
                    <th>Shipping</th>
                    <td>
                  ...
                  <tr>
                    <th>VAT</th>
                    <td>{{Session::get('discounts')['tax']}}VNĐ</td>
                  </tr>
                  <tr>
                    <th>Total</th>
                    <td>{{Session::get('discounts')['total']}}VNĐ</td>
                  </tr>
                </tbody>
              </table>
              @else
              <table class="cart-totals">
                <tbody>
                  ...
                  <tr>
                    <th>VAT</th>
                    <td>{{Cart::instance('cart')->tax()}}VNĐ</td>
                  </tr>
                  <tr>
                    <th>Total</th>
                    <td>{{Cart::instance('cart')->total()}}VNĐ</td>
                  </tr>
                </tbody>
              </table>
              @endif
