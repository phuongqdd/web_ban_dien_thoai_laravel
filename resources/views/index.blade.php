                    ...
                    <div class="pc__info position-relative">
                      ...
                      <div class="product-card__price d-flex">
                        <span class="money price text-secondary">
                          ...
                          <s>{{number_format($sproduct->regular_price, 0, '.', ',')}} VNĐ</s>
                              {{number_format($sproduct->sale_price, 0, '.', ',')}} VNĐ
                          @else
                            {{number_format($sproduct->regular_price, 0, '.', ',')}} VNĐ
                          @endif
                        </span>
                      </div>
                    </div>
                ...
                <div class="product-card__price d-flex align-items-center">
                  <span class="money price text-secondary">
                    @if ($fproduct->sale_price)
                      <s>{{number_format($fproduct->regular_price, 0, '.', ',')}} VNĐ</s>
                        {{number_format($fproduct->sale_price, 0, '.', ',')}} VNĐ
                    @else
                      {{number_format($fproduct->regular_price, 0, '.', ',')}} VNĐ
                    @endif
                  </span>
                </div>
              </div>
